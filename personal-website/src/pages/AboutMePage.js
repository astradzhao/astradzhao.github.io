...
function AboutMePage() {
  return (
    <main className='page-container' role="main">
      ...
      <p className='page-text2'>I recently graduated with my MS in CS at UCSD in December 2025. My research interests include interpretable & steerable generation, ML for music, and how to best utilize LLMs for education.</p>
