...
function AboutMePage() {
  return (
    <main className='page-container' role="main">
      <p className='page-text2'>I'm currently working full-time as an AI Software Engineer at <a href="https://axilon.com/" target="_blank" rel="noopener noreferrer" className="default-link">Axilon</a> in NYC, where we are building a platform for AI-powered industrial application management.</p>
      <p className='page-text2'>I recently completely my MS in CS at UCSD, graduating in December 2025. My research interests include interpretable (and steerable) generation, ML for music, and how to best utilize ML for education.</p>
      <br></br>
      <p className='page-text2'>In fall 2025, I was a TA for <a href="https://cseweb.ucsd.edu/classes/fa25/cse258-a/" target="_blank" rel="noopener noreferrer" className="default-link">CSE 158/258: Web Mining and Recommender Systems</a> under Professor <a href="https://cseweb.ucsd.edu/~jmcauley/" target="_blank" rel="noopener noreferrer" className="default-link">Julian McAuley</a>.</p>
