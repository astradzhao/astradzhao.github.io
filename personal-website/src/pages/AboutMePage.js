...
function AboutMePage() {
  return (
    <div className='page-container'>
      ...
      <p className='page-text2'>I am also interning at Qualcomm, where I am working on the development of a low-resource multimodal RAG QA system through Langchain, to be deployed on a Qualcomm-native Adreno GPU device.</p>
      <br></br>
