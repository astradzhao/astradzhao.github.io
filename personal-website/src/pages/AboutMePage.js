...
function AboutMePage() {
  return (
    <main className='page-container' role="main">
      <p className='page-text2'>I'm currently a MS CS student at UCSD, graduating in Dec 2025. My research focus is in NLP, particularly representation/embedding learning, steerable and human-guided generation, and mechanistic interpretability. My recent work has dealt a lot with music generation. (But I'm also open to other topics!) Since 2024, I have been actively doing research as an intern in both <a href="https://ucsd-musaic.github.io/" target="_blank" rel="noopener noreferrer" className="default-link">MUSAIC</a> and the <a href="https://hao-ai-lab.github.io/" target="_blank" rel="noopener noreferrer" className="default-link">Hao AI Lab</a> at UCSD.</p>
