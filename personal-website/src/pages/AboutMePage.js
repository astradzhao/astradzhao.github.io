...
function AboutMePage() {
  return (
    <div className='page-container'>
      <p className='page-text2'>I'm currently a MS CS student at UCSD, with a research focus in ML Sys, alternative NLP, and increasing global access to AI.</p>
      <p className='page-text2'>I am also currently a TA for the Spring 2025 offering of <a href="https://cseweb.ucsd.edu/classes/sp25/cse253-a/" target="_blank" rel="noopener noreferrer" className="resume-link">CSE 153/253: Machine Learning for Music</a> under Professor <a href="https://cseweb.ucsd.edu/~jmcauley/" target="_blank" rel="noopener noreferrer" className="resume-link">Julian McAuley</a>.</p>
      <p className='page-text2'>In the upcoming summer (2025), I will be interning at Qualcomm, where I will be working on the development of a multimodal QA system.</p>
      <br></br>
